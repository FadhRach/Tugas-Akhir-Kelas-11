            ...
            <div class="col-md-6">
                <div class="card shadow">
                    <div class="card-header py-3 d-flex justify-content-center" style="background:#675D50; color:white;">
                        <h4>FORM PINJAM LOGISTIK</h4>
                    </div>

                    <div class="card-body">
                        <a href="/user/item" class="btn btn-secondary d-flex justify-content-center">kembali</a>
                        
                        <div class="mt-4"></div>
                        
                        <form method="POST" action="/user/item/save">
                            {{ csrf_field() }}
                            ...
                            <div class="form-group">
                                <label>Logistik Yang di Pinjam</label>
                                <select name="id_item" class="form-control">
                                    @foreach($item as $i)
                                    <option value="{{ $i->id_item }}">{{ $i->nameitem }}</option>
                                    @endforeach
                                </select>
                            </div>
